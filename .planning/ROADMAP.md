...
Plans:
- [x] 03-01-PLAN.md — CheckConfig Pydantic module, config/url_checks.yaml, and unit test scaffold
- [x] 03-02-PLAN.md — Wire CheckConfig into ValidationService and ScraperEngine
